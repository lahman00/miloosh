...
const replacements: readonly AffiliateProgramRelationship[] = [
  {
    ...
    evidence: [
      ...
      "Anna provided the Miloosh partnership dashboard URL https://www.jotform.com/partnership/dashboard/?username=Eyal_hello",
      "First-party email from Anna dated 2026-08-26 supplied the account-specific homepage tracking URL https://www.jotform.com/?partner=miloosh and pricing tracking URL https://www.jotform.com/pricing/?partner=miloosh",
      "Current official Jotform affiliate page verified 2026-08-16",
      "data/affiliate/active-partners.ts",
    ],
    ownerBlocker: null,
    formBlocker: null,
    eligibility: "Approved Jotform affiliate publisher as of 2026-08-19; account-specific tracking assets supplied directly by Jotform Partnerships on 2026-08-26",
    applicationUrl: "https://www.jotform.com/partnership/affiliate/application/",
    notes: "Active relationship with vendor-issued partner=miloosh tracking links. The homepage tracking URL is the canonical general CTA; the vendor-issued pricing URL is available for pricing-intent surfaces. The 60-day period is a commission qualification period, not a verified attribution-cookie window. Jotform already participates editorially in the Surveys & Forms recommendation flow; affiliate status must not change its ranking.",
  },
  {
