...
export const OWNER_ACTION_PACKS: readonly OwnerActionPack[] = [
  ...
  },
  {
    ...
    title: "3. Setmore / Tapfiliate PayPal verification",
    priority: 3,
    loginOrSignupUrl: "https://setmore.tapfiliate.com/",
    productsCovered: ["setmore"],
    comparisonsAffected: 0,
    commissionEvidence: "Setmore is a verified active affiliate relationship. Its first-party welcome email explicitly instructs the affiliate to keep PayPal details updated to cash in, and prior verification showed Tapfiliate onboarding at Step 4, payout method.",
    preFilledFields: {
      "Affiliate": "Miloosh",
      "Website": "https://miloosh.com",
      "Payout method expected from first-party welcome email": "PayPal",
    },
    ownerRequiredFields: [
      ...
      "Make PayPal primary if the portal requires a primary payout method",
    ],
    securityAndComplianceNotes: "Do not enter or store PayPal credentials in the repository or chat. The Setmore welcome email is stronger evidence than Tapfiliate's generic method list, so do not substitute Payoneer unless Setmore itself changes its instructions.",
    postCompletionAutomation: "Record Setmore payout readiness only after the affiliate portal shows the PayPal payout method as completed.",
  },
  {
  ...
  },
  {
    ...
    comparisonsAffected: 0,
    commissionEvidence: "CJ is not a core payout rail for the 19 currently active Miloosh partners. Preserve it only for vendors whose current official publisher path genuinely uses CJ, including 1Password and QuickBooks. CJ officially supports publisher payouts through Payoneer as well as direct deposit.",
    preFilledFields: {
