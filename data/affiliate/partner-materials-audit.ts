...
export const PARTNER_MATERIAL_AUDIT: readonly PartnerMaterialAudit[] = [
  ...
  record({
    ...
    commission: { type: "fixed_cpa", value: "$10 per qualified free trial; up to $200 per paid customer", originalWording: "Earn $10 for every free trial you refer, and up to $200 per paid customer you refer." },
    recurrence: "Per qualifying referral action; recurring commission not established",
    cookieWindow: "90 days from referral click to trial start", payoutThreshold: "$5",
    payoutMethod: "PartnerStack; actual payout configuration remains UNVERIFIED",
    qualificationRules: "Referral click and trial start within 90 days per welcome email; full eligibility terms remain separate",
  ...
  ...[["Zendesk", "zendesk"]].map(([company, slug]) => record({ company: company!, slug: slug!, programNetwork: "PartnerStack", currentStatus: "PENDING", applicationStatus: "Under review", approvalStatus: "Not approved", readiness: "PENDING APPROVAL", evidence: [STATUS_DRAFT], lastVerifiedDate: "2026-08-19" })),
  ...
  record({ company: "SurveyMonkey", slug: "surveymonkey", programNetwork: "PartnerStack", currentStatus: "ACTIVE", applicationStatus: "Approved (per 2026-08-24 owner-supplied evidence)", approvalStatus: "Exact replacement asset confirmed by vendor and program managers 2026-09-02", affiliateUrl: "https://get.surveymonkey.com/tbaic7ngidg4", commission: { type: "unknown", value: UNKNOWN, originalWording: "Per current PartnerStack program terms; exact current rate not recorded in durable evidence" }, readiness: "READY NOW", evidence: ["2026-09-10 reconciliation: docs/surveymonkey-reconciliation-2026-09-10.md; direct Gmail messages 1a0623b44e98ed89, 1a0623c265569be2 and 1a062aa8a45e7989 confirm the replacement asset; historical old link remains unverified. READY NOW describes a technical CTA only, NOT verified payout readiness.", "Owner screenshot of logged-in SurveyMonkey PartnerStack dashboard, 2026-08-24", "Owner-supplied exact referral URL, 2026-08-24 (historical, preserved in data/affiliate/canonical-ledger.ts, no longer used as the live CTA destination): https://try.partnerstack.com/jx99ylh3mexb", "data/software/surveymonkey.json", "data/affiliate/canonical-ledger.ts", "Historical 2026-08-29 fail-close applies only to the OLD asset https://try.partnerstack.com/jx99ylh3mexb: it had not been first-party confirmed for Miloosh on the correct PartnerStack account and was removed from active CTAs. The replacement asset https://get.surveymonkey.com/tbaic7ngidg4 was separately confirmed by vendor/program managers on 2026-09-02; payout readiness remains unverified."], lastVerifiedDate: "2026-09-10" }),
  record({ company: "Jotform", slug: "jotform", programNetwork: "Direct (Jotform)", currentStatus: "ACTIVE", applicationStatus: "Approved", approvalStatus: "Approved 2026-08-19", affiliateUrl: "https://www.jotform.com/?partner=miloosh", commission: { type: "recurring_percentage", value: "30% for 12 months", originalWording: "Earn a 30% commission on every new paid user you refer, paid monthly for the first 12 months of the customer's subscription" }, recurrence: "recurring for 12 months", cookieWindow: "60-day qualification window (distinct from a click-attribution cookie)", payoutMethod: "Tremendous (per jotform.com/partnership/affiliate/)", qualificationRules: "Free to join; case-by-case approval; not required to be an existing paid customer", readiness: "READY NOW", evidence: [PROGRAM_RESEARCH, "Owner's own first-hand account, 2026-08-29, of personally re-reading the original correspondence in the connected Gmail account: Jotform Affiliate Marketing Specialist Anna Scheucher confirmed approval for account 'Eyal_hello' (hello@miloosh.com) and supplied both tracking URLs recorded here", "data/affiliate/active-partners.ts", "data/affiliate/canonical-ledger.ts"], lastVerifiedDate: "2026-08-29" }),
