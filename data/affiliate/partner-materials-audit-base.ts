...
export const PARTNER_MATERIAL_AUDIT: readonly PartnerMaterialAudit[] = [
  ...
  record({ company: "SurveyMonkey", slug: "surveymonkey", programNetwork: "PartnerStack", currentStatus: "ACTIVE", applicationStatus: "Approved", approvalStatus: "Approved", affiliateUrl: "https://try.partnerstack.com/jx99ylh3mexb", commission: { type: "unknown", value: UNKNOWN, originalWording: "Per current PartnerStack program terms; exact current rate not recorded in durable evidence" }, readiness: "READY NOW", evidence: ["Owner screenshot of logged-in SurveyMonkey PartnerStack dashboard, 2026-08-24", "Owner-supplied exact referral URL, 2026-08-24", "data/software/surveymonkey.json", "data/affiliate/active-partners.ts", "data/affiliate/canonical-ledger.ts"], lastVerifiedDate: "2026-08-24" }),
