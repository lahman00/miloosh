...
/**
 * ERP/Payments batch (2026-09-05 catalog-expansion-100 sprint) — covers
 * exactly the 6 files this batch added: NetSuite, Odoo, PayPal Payments,
 * Sage Intacct, SAP Cloud ERP, SAP Concur (all category "finance-and-erp").
 *
...
const MY_SLUGS = ["netsuite", "odoo", "paypal-payments", "sage-intacct", "sap-cloud-erp", "sap-concur"] as const;
...
describe("ERP/Payments batch — NetSuite, Odoo, PayPal Payments, Sage Intacct, SAP Cloud ERP, SAP Concur", () => {
