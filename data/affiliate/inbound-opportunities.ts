...
export const INBOUND_AFFILIATE_OPPORTUNITIES: readonly InboundAffiliateOpportunity[] = [
  ...
  },
  {
    ...
    sourceEvidence: [
      "Direct PartnerStack invitation email to hello@miloosh.com from Amir at Notify Me offering 20% recurring commission for new paid referrals",
      "Miloosh replied on 2026-08-24, but Gmail delivery-delay notices show that message did not reach the PartnerStack relay address",
      "Current official Notify Me affiliate page now states 50% revenue share for the first six months and 25% for life thereafter, free to join on PartnerStack, no referral cap, and explicitly welcomes creators, educators, communities, and other audience publishers",
      "Miloosh emailed Notify Me's official partnerships address partnership@notify-me.io on 2026-08-26 asking which economics control the existing invitation and requesting current attribution, publisher eligibility, promotional restrictions, and geography before acceptance",
    ],
    inviteUrl: "https://dash.partnerstack.com/invite/e2503a962bef4c12b2c7f536cd89746a",
    headlineOffer: "20% recurring commission for new paid referrals (direct invitation wording)",
    verifiedPublicEconomics: "Current official affiliate page states 50% of referred merchant subscription revenue for months 1-6, then 25% for life while the merchant remains subscribed; PartnerStack-managed, monthly revenue share, free to join, no referral cap",
    publicTermsUrl: "https://notify-me.io/affiliate-program",
    affiliateUrl: null,
    acceptedAt: null,
    ownerAcceptanceRequired: true,
    nextAction: "Wait for Notify Me Partnerships to reconcile the direct invitation's 20% wording with the current public 50%-then-25% affiliate structure and confirm the controlling attribution and promotional terms. Do not accept the invitation until that confirmation is received.",
    notes: "No Notify Me software record currently exists in Miloosh. Do not manufacture one solely to activate the affiliate invitation. The current public affiliate page supports content-publisher fit, but any future catalog or comparison coverage must be justified by independent editorial research into the Shopify/BigCommerce notification and conversion software category.",
  },
] as const;